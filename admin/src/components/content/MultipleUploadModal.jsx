                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    >
                      ...
                      {phases.map((phase) => (
                        <option key={phase._id} value={phase._id} className="bg-gray-900 text-green-400">
                          ▸ {phase.title}
                        </option>
                      ))}
                    </select>
                      ...
                      <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          {multipleUploads.length > 1 && (
                            <button
                              onClick={() => onRemoveUploadItem(item._id)}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                          ...
                          <div className="relative">
                            ...
                            <div className="relative">
                              ...
                              <input
                                type="text"
                                value={sectionInputValues[item._id] || item.section || ""}
                                onChange={(e) => handleSectionInputChange(item._id, e.target.value)}
                                onFocus={() => handleItemSectionFocus(item._id)}
                                onBlur={() => handleItemSectionBlur(item._id)}
                              ...
                              />
                              {selectedModuleForUpload && !sectionLoading && (sectionInputValues[item._id] || item.section) && (
                            ...
                            {/* Section Dropdown */}
                            {sectionDropdowns[item._id] && selectedModuleForUpload && (
                              <div className="absolute z-50 w-full mt-2 bg-gray-800 border border-green-500/50 rounded-lg shadow-2xl max-h-48 overflow-auto backdrop-blur-sm">
                                ...
                                {(() => {
                                  const currentInput = sectionInputValues[item._id] || item.section || "";
                                      ...
                                      <>
                                        ...
                                        {filteredSections.map((section) => (
                                          <button
                                            key={section}
                                            type="button"
                                            onClick={() => handleItemSectionSelect(item._id, section)}
