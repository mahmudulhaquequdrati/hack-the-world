...
Delivery Service`,
  ...
  const osintTools = [
    ...
    },
    {
      ...
      description: "Analyze domain registration and history",
    },
    {
    ...
    },
    {
      ...
      description: "Gather information about phone numbers",
    },
  ];
          ...
          <div className="space-y-6">
            ...
            <div className="bg-yellow-900/20 border border-yellow-400/30 rounded p-4">
              ...
              <p className="text-yellow-300 text-sm">
                This tool is for educational purposes only. Never use these
                techniques for malicious purposes. Always obtain proper
                authorization before conducting security tests.
              </p>
            </div>
          </div>
        );
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2">
                  {osintTools.map((tool, index) => (
                    <div
                      key={index}
                      className="p-3 border border-green-400/30 rounded"
                    >
                ...
                {osintResults.length === 0 ? (
                  ...
                  osintResults.map((result, index) => (
                    <div
                      ...
                      className={`${
                        result.includes("---")
                          ? "text-green-400 border-b border-green-400/30 my-2"
                          : result.includes("•")
                          ? "text-red-400"
                          : result.includes(":")
                          ? "text-green-300"
              ...
              <div className="space-y-3">
                <div className="p-4 border border-green-400/30 rounded">
                  <h4 className="font-bold text-green-400 mb-2">
                    Scenario 1: IT Support Call
                  </h4>
                  <p className="text-green-300 text-sm mb-3">
                    You're calling as IT support to verify user credentials due
                    to a "security incident."
                  </p>
                  <div className="space-y-2 text-sm">
                    <div>
                      <strong className="text-green-400">Opening:</strong> "Hi,
                      this is [Name] from IT Security. We've detected unusual
                      activity on your account."
                    </div>
                    <div>
                      <strong className="text-green-400">Hook:</strong> "We need
                      to verify your identity to secure your account."
                    </div>
                    <div>
                      <strong className="text-green-400">Ask:</strong> "Can you
                ...
                <div className="p-4 border border-green-400/30 rounded">
                  ...
                  <p className="text-green-300 text-sm mb-3">
                    Calling as a trusted vendor needing to update payment
                    information.
                  </p>
                  <div className="space-y-2 text-sm">
                    <div>
                      <strong className="text-green-400">Opening:</strong>{" "}
                      "Hello, I'm calling from [Vendor Company] regarding your
                      account."
                    </div>
                    <div>
                      <strong className="text-green-400">Hook:</strong> "We need
                      to update our payment processing system."
                    </div>
                    <div>
                      <strong className="text-green-400">Ask:</strong> "Can you
                      verify the credit card on file?"
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="p-4 border border-green-400/30 rounded">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="text-green-300">
                      <strong>Spear Phishing:</strong> Use personal information
                      to craft targeted emails
                    </div>
                    <div className="text-green-300">
                      <strong>Social Engineering:</strong> Leverage
                      relationships and interests
                    </div>
                    <div className="text-green-300">
                      <strong>Pretexting:</strong> Use professional information
                      for credibility
                    </div>
                  </div>
                </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-green-300/70">
                Learn psychological manipulation techniques and defenses
              </p>
            </div>
          </div>
