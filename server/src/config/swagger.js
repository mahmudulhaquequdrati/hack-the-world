      ...
      schemas: {
        ...
        Phase: {
          ...
          properties: {
            ...
            name: {
              type: "string",
              example: "Beginner Phase",
            },
            description: {
              type: "string",
              example: "Foundation building with core cybersecurity concepts",
            },
            difficulty: {
              type: "string",
        ...
        Module: {
          ...
          properties: {
            ...
            description: {
              type: "string",
              example: "Learn the fundamentals of encryption and decryption",
            },
            difficulty: {
              type: "string",
              enum: ["beginner", "intermediate", "advanced"],
        ...
        Lab: {
          ...
          properties: {
            ...
            description: {
              type: "string",
              example:
                "Practice decrypting messages using Caesar cipher techniques",
            },
            difficulty: {
              type: "string",
              enum: ["beginner", "intermediate", "advanced"],
            ...
            steps: {
              ...
              items: {
                ...
                properties: {
                  ...
                  content: {
                    type: "string",
                    example: "Examine the cipher text and identify patterns",
                  },
                  command: {
                    type: "string",
                    example: 'echo "KHOOR ZRUOG" | tr "A-Z" "X-ZA-W"',
                  },
                },
              },
            },
            tools: {
              type: "array",
              items: { type: "string" },
              example: ["terminal", "text-editor", "cipher-wheel"],
            },
          },
        },
        Game: {
          ...
          properties: {
            ...
            description: {
              type: "string",
              example: "Crack encrypted messages to earn points",
            },
            type: {
              type: "string",
              enum: ["puzzle", "simulation", "challenge"],
              example: "puzzle",
            },
            difficulty: {
              type: "string",
        ...
        Achievement: {
          ...
          properties: {
            ...
            name: {
              type: "string",
              example: "Welcome Hacker",
            },
            description: {
              type: "string",
              example: "Successfully logged into the platform",
            },
            icon: {
              type: "string",
              example: "🎯",
