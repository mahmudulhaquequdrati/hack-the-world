      ...
      lessons: [
        {
          ...
          type: 'video',
          duration: '15 min',
          content: 'Learn about Linux history, distributions, and basic concepts.'
        },
        {
          id: 2,
          ...
          type: 'interactive',
          duration: '20 min',
          content: 'Practice navigating the Linux file system using cd, ls, and pwd commands.'
        },
        {
          id: 3,
          ...
          type: 'hands-on',
          duration: '25 min',
          content: 'Learn to create, copy, move, and delete files and directories.'
        },
        {
          id: 4,
      ...
      lessons: [
        {
          ...
          type: 'video',
          duration: '30 min',
          content: 'Introduction to web application security concepts and threat landscape.'
        },
        {
          id: 2,
          title: 'SQL Injection',
          type: 'hands-on',
          duration: '45 min',
          content: 'Learn to identify and exploit SQL injection vulnerabilities.'
        },
        {
          id: 3,
          ...
          type: 'interactive',
          duration: '40 min',
          content: 'Understand different types of XSS attacks and prevention methods.'
        },
        {
          id: 4,
        ...
        },
        {
          ...
          type: 'video',
          duration: '25 min',
          content: 'Overview of popular web security testing tools and frameworks.'
        }
      ]
    }
  };
          ...
          <div className="space-y-4">
            <div className="bg-black rounded-lg aspect-video flex items-center justify-center border border-green-400/30">
              <div className="text-center">
                ...
                <p className="text-green-300/60 text-sm">Duration: {currentLessonData.duration}</p>
              </div>
            </div>
        ...
        return (
          <div className="space-y-4">
            <div className="bg-black rounded-lg p-6 border border-green-400/30">
              <div className="space-y-4">
                <h3 className="text-lg font-bold text-green-400">Interactive Exercise</h3>
      ...
      case 'hands-on':
        return (
          <div className="space-y-4">
            <div className="bg-black rounded-lg p-6 border border-green-400/30">
              <div className="space-y-4">
                <h3 className="text-lg font-bold text-green-400">Hands-On Lab</h3>
                <p className="text-green-300">{currentLessonData.content}</p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-green-900/20 border border-green-400/30 rounded p-4">
                    <h4 className="font-bold text-green-400 mb-2">Objectives:</h4>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-green-400 flex items-center">
                    {React.createElement(getLessonIcon(currentLessonData.type), { className: "w-5 h-5 mr-2" })}
