...
const Dashboard = () => {
  ...
  const achievements = [
    ...
    },
    {
      ...
      description: "Complete 50 terminal commands",
      earned: true,
    },
    {
      title: "Web Warrior",
          ...
          <TabsContent value="courses" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {courses.map((course) => (
                <Card
                  key={course.id}
                  className="bg-black/50 border-green-400/30 hover:border-green-400 transition-all group cursor-pointer"
              ...
              {labs.map((lab) => (
                ...
                >
                  <CardHeader className="text-center">
                    <lab.icon
                      className={`w-16 h-16 mx-auto ${lab.color} group-hover:scale-110 transition-transform`}
                    />
                    <CardTitle className="text-green-400">
                      {lab.title}
                    </CardTitle>
              ...
              {achievements.map((achievement, index) => (
                <Card
                  ...
                  className={`bg-black/50 border-green-400/30 ${
                    achievement.earned ? "border-green-400" : "opacity-50"
                  }`}
                >
                  <CardContent className="p-4">
                    <div className="flex items-center space-x-3">
