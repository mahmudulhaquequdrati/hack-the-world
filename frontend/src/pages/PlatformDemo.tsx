...
const PlatformDemo = () => {
  ...
  const demoSteps = {
    terminal: [
      ...
      "cybersec-trainee",
      "$ pwd",
      "/home/cybersec-trainee/labs",
      "$ ls -la",
      "total 12",
      "drwxr-xr-x 3 cybersec-trainee cybersec-trainee 4096 Dec 15 10:30 .",
      "drwxr-xr-x 5 cybersec-trainee cybersec-trainee 4096 Dec 15 10:25 ..",
      "drwxr-xr-x 2 cybersec-trainee cybersec-trainee 4096 Dec 15 10:30 vulnerable-app",
      "$ cd vulnerable-app",
      "$ nmap -sV localhost",
