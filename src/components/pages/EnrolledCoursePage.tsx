      ...
      lessons: [
        {
          ...
          description:
            "Welcome to Linux! In this lesson, we'll explore the history and philosophy of Linux.",
...
Let's begin this exciting journey together!`,
        },
        {
          ...
          videoUrl:
            "https://images.pexels.com/photos/11035380/pexels-photo-11035380.jpeg",
          description:
            "Master the Linux file system structure and navigation commands.",
...
Practice makes perfect - we'll work through real-world scenarios in the terminal playground.`,
        },
        {
          ...
          videoUrl:
            "https://images.pexels.com/photos/11035380/pexels-photo-11035380.jpeg",
          description:
            "Master powerful text processing tools like grep, sed, and awk.",
        ...
        return (
          <div className="h-full bg-black rounded border border-green-400/30 p-4 font-mono">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="text-green-300">
                -rw-r--r-- 1 user user 3771 Dec 15 10:25 .bashrc
              </div>
              <div className="text-green-300">
            ...
            <div className="mt-6 p-3 bg-green-400/10 rounded border border-green-400/30">
              ...
              <div className="text-green-300 text-sm">
                Navigate to the Documents directory and create a new file called
                "practice.txt"
              </div>
            </div>
          </div>
