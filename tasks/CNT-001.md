...
Create a simplified, unified Content model that handles all types of content (videos, labs, games) within modules. This replaces the need for separate Video, Lab, Game, and Document models, making the system much simpler to maintain and extend.
...
describe("Content Model", () => {
  ...
  describe("Content Queries", () => {
    ...
    it("should get content by module", async () => {
      ...
      expect(content[0].order).toBeLessThan(content[1].order);
    });
