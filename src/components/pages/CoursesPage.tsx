      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-green-300/80 text-lg max-w-2xl mx-auto">
            Master cybersecurity with our comprehensive courses designed by
            industry experts. From beginner to advanced, we have the perfect
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCourses.map((course) => (
            <Card
              key={course.id}
              className="bg-black/50 border-green-400/30 hover:border-green-400 transition-all duration-300 group cursor-pointer overflow-hidden"
            >
              <div className="relative">
                <img
                  src={course.image}
